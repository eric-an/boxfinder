...
Box.create(length: 14, width: 12, height: 4, location: "D")
...
Box.create(length: 8, width: 6, height: 6, location: "F")
Box.create(length: 9, width: 9, height: 9, location: "F")
...
#section G
Box.create(length: 12, width: 12, height: 9, location: "G")
Box.create(length: 13, width: 10, height: 10, location: "G")
Box.create(length: 13, width: 13, height: 7, location: "G")
Box.create(length: 14, width: 10, height: 10, location: "G")
Box.create(length: 15, width: 15, height: 10, location: "G")
Box.create(length: 16, width: 10, height: 6, location: "G")
Box.create(length: 16, width: 14, height: 6, location: "G")
...
#section I
Box.create(length: 12, width: 10, height: 4, location: "I")
Box.create(length: 12, width: 12, height: 4, location: "I")
Box.create(length: 18, width: 16, height: 4, location: "I")
